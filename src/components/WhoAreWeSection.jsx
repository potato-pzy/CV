...
function WhoAreWeSection() {
    ...
    // Track mobile viewport using matchMedia so it reacts to orientation/resize
    useEffect(() => {
    ...
    useEffect(() => {
        // On mobile, keep sections always visible to avoid missed triggers on fast scroll
        if (isMobile) {
    ...
    return (
        <div className={`whoarewe-page ${isMobile ? 'whoarewe-no-anim' : ''}`}>
